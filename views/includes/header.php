    ...
    ****************************************** 
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="blanco col-lg-3">
                        <!-- <form class="form-inline w-100 row">
                            <input class="form-control mr-sm-2 d-none d-lg-inline col-lg-8" type="search" placeholder="Buscar"
                                aria-label="Search">
                            <button class="btn btn-success my-2 my-sm-0 d-none d-lg-inline col-lg-3" type="submit">Buscar</button>
                        </form> -->
                    </div>
                </div>
            </div>
    ...
    <!-- ------------- MENU -------------  -->
    <nav class="navbar navbar-expand-lg navbar-light bg-success container-fluid sticky-top">
