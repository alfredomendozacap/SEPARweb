...
function Dropify(element, options) {
    ...
    var defaults = {
        ...
        messages: {
            'default': 'Agarra y suelta una imagen o haz click',
            'replace': 'Agarra y suelta una imagen o haz click para reemplazar',
            'remove': 'Remover',
            'error': 'Error, la imagen pesa más de 2MB'
        },
        error: {
        ...
        tpl: {
            ...
            preview:         '<div class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-infos-message text-center">{{ replace }}</p></div></div></div>',
